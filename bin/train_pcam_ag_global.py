...
parser.add_argument('--pre_train_gloabl', default="/content/pcam_pg/config/pre_train.pth", type=str, help="If get"
                    "parameters from pretrained model")
parser.add_argument('--pre_train_local', default="/content/pcam_pg/config/pre_train.pth", type=str, help="If get"
                    "parameters from pretrained model")
